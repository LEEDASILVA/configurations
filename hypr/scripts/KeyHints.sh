...
"" "" "" \
" G" "Group Windows" "" \
" CTRL tab" "Change group active" "switch between tabs" \
...
"CTRL ALT A" "power-menu" "(wlogout)" \
"CTRL ALT L" "screen lock" "(hyprlock)" \
"CTRL ALT Del" "Hyprland Exit" "(NOTE: Hyprland Will exit immediately)" \
" F" "Fullscreen" "Toggles to full screen" \
" SHIFT F" "Fake Fullscreen" "Toggles to fake full screen" \
" ALT D" "Toggle Dwindle | Master Layout" "Hyprland Layout" \
...
" CTRL Z" "Launch this Quick Cheat Sheet" "" \
"" "" "" \
" ALT H" "swap windows workspace" "(left)"
" ALT L" "swap windows workspace" "(right)"
" ALT K" "swap windows workspace" "(up)"
" ALT J" "swap windows workspace" "(down)"
"" "" "" \
" SHIFT U" "move to workspace" "(special)"
